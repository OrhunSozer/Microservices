    ...
    public static class Config
    {
        ...
        public static IEnumerable<ApiScope> ApiScopes =>
            new ApiScope[]
            {
                ...
                new ApiScope("payment_fullpermission", "full permission for Photo FakePayment API"),
                new ApiScope("gateway_fullpermission", "full permission for Photo Gateway API"),
